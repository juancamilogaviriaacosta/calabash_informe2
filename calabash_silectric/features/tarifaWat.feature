Feature: Tarfia por watt

  Scenario: Como usuario quiero definir la tarifa por watt
    Given I wait for 2 seconds
    When I clear input field number 1
    And I enter "99999999999999999999999999999999999999999999999999999999999999999999999999" into input field number 1
